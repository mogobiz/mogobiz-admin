		...
		<div id="content" style="display: none;">
			<div class="panel">
				...
				<div class="panel_body">
					<!---------------------------------------------------------------------------------------------------->
					<div class="section_title"><g:message locale="${lang}" code="customer.event.ticketInformation.label" /></div>
					<div class="section" id="ticketInformation">
						<table border="0">
						  <tr id="eventStartDateLine">
						    <td><b><g:message locale="${lang}" code="customer.event.start.label" />:&nbsp;&nbsp;</b></td>
						    <td id="eventStartDate"></td>
						  </tr>
						  <tr id="eventEndDateLine">
						    <td><b><g:message locale="${lang}" code="customer.event.end.label" />:&nbsp;&nbsp;</b></td>
						    <td id="eventEndDate"></td>
						  </tr>
						  <tr id="eventLocationLine">
						    <td><b><g:message locale="${lang}" code="customer.event.where.label" />:&nbsp;&nbsp;</b></td>
						...
						<div id="event-date-time">
							<div id="date_div">
								<b><g:message locale="${lang}" code="customer.event.date.label" />:&nbsp;&nbsp;</b><input type="text" id="event_date" />
							</div>
							<div id="time_div">
								<b><g:message locale="${lang}" code="customer.event.time.label" />:&nbsp;&nbsp;</b>
								<select id="event_time" disabled="disabled">
									<option value=""><g:message locale="${lang}" code="customer.event.selectTime.label" /></option>
								</select>
							</div>
						</div>
						...
						<div id="errorMessage" class="ui-widget" style="display: none;">
							<div class="ui-state-error ui-corner-all" style="padding: 0 .7em;"> 
								...
								<strong><g:message locale="${lang}" code="customer.event.error.label" />:</strong>&nbsp;&nbsp;&nbsp;<span class="message"></span></p>
							</div>
							<br style="clear: both;"/>
						</div>
						...
						<table cellpadding="0" cellspacing="0">
							<thead>
								<tr>
									<td class="hidden"></td>
									<td><h2><g:message locale="${lang}" code="customer.event.ticketType.label" /></h2></td>
									<td><h2><g:message locale="${lang}" code="customer.event.salesEnd.label" /></h2></td>
									<td><h2><g:message locale="${lang}" code="customer.event.price.label" /></h2></td>
									<td class="last"><h2><g:message locale="${lang}" code="customer.event.quantity.label" /></h2></td>
								</tr>
							</thead>
							<tbody></tbody>
						</table>
						...
						<label style="float:right; position: relative; right: 39px;" class="uiButton uiButtonConfirm uiButtonMedium"><input type="submit" id="registerButton" value="<g:message locale="${lang}" code="customer.event.register.label" />" style="width:95px;"></input></label>
					...
					<div class="section_title"><g:message locale="${lang}" code="customer.event.pictures.label" /></div>
					<div class="section" id="screenshots">
						<a href="javascript:;" class="controls prev"><g:message locale="${lang}" code="customer.event.previous.label" /></a>
						<div class="scrollable"><div class="items"></div></div>
						<a href="javascript:;" class="controls next"><g:message locale="${lang}" code="customer.event.next.label" /></a>
					</div>
					</div>
					...
					<div id="eventDetailsDiv">
						<div class="section_title"><g:message locale="${lang}" code="customer.event.eventDetails.label" /></div>
						<div class="section" id="eventDetails"></div>
					</div>
					
					<!---------------------------------------------------------------------------------------------------->
					
					<div class="section_title"><g:message locale="${lang}" code="customer.event.location.label" /></div>
					<div class="section" id="eventLocation">
						...
						<div id="poiInfoWindow" style="display:none;">
							<div id="showPoiInfoDiv" style="padding: 5px; width:200px;">
								<div>
									<span id="poiName_info"><b><g:message locale="${lang}" code="customer.event.poi.name.label" />:&nbsp;</b><span id="poiNameLabel"></span><br/></span>
									<span id="poiCountry_info"><b><g:message locale="${lang}" code="customer.event.poi.country.label" />:&nbsp;</b><span id="poiCountryLabel"></span><br/></span>
									<span id="poiCity_info"><b><g:message locale="${lang}" code="customer.event.poi.city.label" />:&nbsp;</b><span id="poiCityLabel"></span><br/></span>
									<span id="poiRoad_info"><b><g:message locale="${lang}" code="customer.event.poi.street.label" />:&nbsp;</b><span id="poiRoadLabel"></span><br/></span>
									<span id="poiPostalCode_info"><b><g:message locale="${lang}" code="customer.event.poi.postalcode.label" />:&nbsp;</b><span id="poiPostalCodeLabel"></span><br/></span>
									<span id="poiDesc_info"><b><g:message locale="${lang}" code="customer.event.poi.description.label" />:&nbsp;</b><span id="poiDescLabel"></span><br/></span>
								</div>
							</div>
						</div>
						<div class="clear"></div>
					...
					<div class="section_title"><g:message locale="${lang}" code="customer.event.comments.label" /></div>
