			...
			<ul class="tabs">
				<li>
					<a id="categoryGeneralTab">
						<g:message locale="${lang}" code="category.tabs.general.label" />
					</a>
				</li>
				<li>
					<a id="categoryVariationsTab">
						<g:message locale="${lang}" code="category.tabs.variations.label" />
					</a>
				</li>
				<li>
					<a id="categoryFeaturesTab">
						<g:message locale="${lang}" code="category.tabs.features.label" />
					</a>
				</li>
				<li>
					<a id="categoryProductsTab">
						<g:message locale="${lang}" code="category.tabs.products.label" />
					</a>
				</li>
				<li>
...
<store:hasPermission permission="${PermissionType.ADMIN_STORE_USERS.key}">
			...
			<form id="categoryEditGeneralForm" onsubmit="return false;" enctype="multipart/form-data">
				...
				<div class="newline">
					<div class="category-general-medium">
						<label for="categoryEditName"><g:message locale="${lang}" code="category.tabs.general.name.label" />&nbsp;<sup>*</sup></label>
					</div>
					<div class="category-general-medium">
						<label for="categoryEditExternalCode"><g:message locale="${lang}" code="category.tabs.general.externalCode.label" /></label>
					</div>
				</div>
				...
				<div class="newline">
					<div class="category-general-medium">
						<label for="categoryEditIBeacon"><g:message locale="${lang}" code="category.tabs.general.iBeacon.label" /></label>
					</div>
                    <div class="category-general-medium">
						<label for="categoryEditUUID"><g:message locale="${lang}" code="category.tabs.general.uuid.label" /></label>
					</div>
				</div>
				<div class="spacer-small"></div>
				<div class="newline">
				...
				<div class="newline">
					<div class="category-general-full">
						<label for="categoryEditDescription"><g:message locale="${lang}" code="category.tabs.general.descripton.label" /></label>
					</div>
				</div>
				<div class="spacer-small"></div>
				<div class="newline">
        ...
        <div id="categorySecurityTabInfo">
            <div>
                <label for="categorySecurityUsers"><g:message locale="${lang}" code="security.users.label" /></label>
            </div>
