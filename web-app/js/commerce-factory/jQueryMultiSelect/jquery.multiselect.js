...
$.widget("ech.multiselect", {
	...
	options: {
		...
		minWidth: 225,
		classes: '',
		checkAllText: multiselectCheckAllLabel,
		uncheckAllText: multiselectUncheckAllLabel,
		noneSelectedText: multiselectSelectOptionsLabel,
		selectedText: '# ' + multiselectSelectedLabel,
		selectedList: 0,
		show: '',
		hide: '',
		autoOpen: false,
		...
		this.element.find('option').each(function(i){
			...
			if( value.length > 0 ){
				...
				if($this.attr("editable") == "true")
					liOption += '<img onclick="' + $this.attr("editFunction") + '" src="../images/edit_icon.png" style="width:13px; height:13px;"/>&nbsp;';
				liOption += title + '</span>'; //Ahmad Ibrahim
