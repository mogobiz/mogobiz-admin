 ...
 *
 * $Date: 2011-02-09 01:17:14 +0200 (cp, 09 sep 2011) $
 * $Revision: 236 $
 */
...
(function ($) {
	$.vakata.context = {
		...
		parse	: function (s, is_callback) {
			...
			$.each(s, function (i, val) {
				...
				if(val.icon && val.icon.indexOf("/") === -1) { str += "<ins class='" + val.icon + "'>&#160;</ins>"; }
				if(val.icon && val.icon.indexOf("/") !== -1) { str += "<ins style='background:url(" + val.icon + ") center center no-repeat;'>&#160;</ins>"; }
				str += "<a href='#' rel='" + i + "'>";
				if(val.submenu) {
	...
	$(function () {
		var css_string = '' + 
			'#vakata-contextmenu { text-align:left; display:block; visibility:hidden; left:0; top:-200px; position:absolute; margin:0; padding:0; min-width:110px; background: #FFF; border: 1px solid #D8DEEA; z-index:10000; *width:180px; } ' + 
			'#vakata-contextmenu ul { min-width:110px; *width:180px; } ' + 
			'#vakata-contextmenu ul, #vakata-contextmenu li { margin:0; padding:0; list-style-type:none; display:block; } ' + 
			'#vakata-contextmenu li { line-height:20px; min-height:20px; position:relative; padding:0px; border-bottom: 1px solid #D8DEEA;} ' + 
