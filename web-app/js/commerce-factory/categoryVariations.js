...
function categoryVariationUpdateTranslationValues(values){
    ...
    for(var i = 0; i < values.length; i++){
        var dataToSend = "target=" + tab[i].id + "&language=" + language + "&type=VARIATION_VALUE&value={\"value\":\"" + encodeURIComponent(values[i]) + "\"}";
...
function categoryVariationCreateTranslationValues(language, variationId){
    ...
    for(var i = 0; i < tab.length; i++){
        var dataToSend = "target=" + tab[i].id + "&language=" + language + "&type=VARIATION_VALUE&value={\"value\":\"" + encodeURIComponent(tab[i].value) + "\"}";
