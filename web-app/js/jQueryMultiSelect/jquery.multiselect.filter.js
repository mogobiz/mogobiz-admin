...
(function($){
	...
	$.widget("ech.multiselectfilter", {
		...
		options: {
			id: "multiselectfilter_searchInput",
			label: "Filter:",
		...
		_create: function(){
			...
			.bind({
				...
				keyup: $.proxy(self._handlerAjax, self),
		...
		_handlerAjax: function( e ){
			if(this.options.ajaxHandler) {
				if(this.options.param) {
					this.options.ajaxHandler(this.options.param);
				} else {
					this.options.ajaxHandler();
				}
			}
			this._handler(e);
		},
