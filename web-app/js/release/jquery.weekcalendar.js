...
(function($) {
   ...
   $.widget("ui.weekCalendar", {
       ...
       options : {
         ...
         use24Hour : false,
         daysToShow : 7,
         firstDayOfWeek : 0, // 0 = Sunday, 1 = Monday, 2 = Tuesday, ... , 6
								// = Saturday
      ...
      /*
		 ...
		 */
      refresh : function() {
         this._loadCalEvents(this.element.data("startDate")); // reload with
																// existing week
      },
      ...
      /*
		 ...
		 */
      prevWeek : function() {
         // minus more than 1 day to be sure we're in previous week - account
			// for daylight savings or other anomolies
...
/*
 * getData : function(key) { return this._getData(key); },
 */
         ...
         $weekDay.mousedown(function(event) {
            ...
            if ($newEvent.length) {
               ...
               /*
				 ...
				 * self._adjustForEventCollisions($weekDay, $renderedCalEvent,
				 * newCalEvent, newCalEvent); self._positionEvent($weekDay,
				 * $renderedCalEvent); } else {
            ...
            $.each(groupsList, function() {
               ...
               $.each(curGroups, function(groupIndex) {
                  ...
                  if (self.options.overlapEventsSeparate) {
                     ...
                     // TO DO what happens when the group has more than 10
						// elements
