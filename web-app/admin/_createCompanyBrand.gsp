<div id="companyBrandsTabs">
        ...
        <form id="companyBrandsForm" onsubmit="return false;" method="POST" enctype="multipart/form-data">
            ...
            <div class="newline">
                <div class="companyBrandsDialog-large">
                    <div class="newline">
                        <div class="companyBrandsDialog-large">
                            <label for="companyBrandsName"><g:message code="company.brands.name.label"></g:message>&nbsp;<sup>*</sup></label>
                    ...
                    <div class="newline">
                        <div class="companyBrandsDialog-large">
                            <label for="companyBrandsWebsite"><g:message code="company.brands.website.label"></g:message></label>
                            <div class="spacer-small"></div>
                    ...
                    <div class="newline">
                        <div class="companyBrandsDialog-large">
                            <label for="companyBrandsIBeacon"><g:message code="company.brands.iBeacon.label" /></label>
                            <div class="spacer-small"></div>
                ...
                <div class="companyBrandsDialog-small">
                    ...
                    <a href="javascript:void(0)" id="companyBrandsRemoveLogoLink"><g:message code="company.brands.deleteLogo.label"/></a>
                </div>
            </div>
            <div class="spacer"></div>
            <div class="newline">
                <div class="companyBrandsDialog-full">
                    <label for="companyBrandsDescription"><g:message code="company.brands.description.label" /></label>
                </div>
            </div>
            <div class="spacer-small"></div>
            <div class="newline">
            ...
            <div>
                ...
                <label for="companyBrandsHide"><g:message code="company.brands.hide.label" /></label>
            </div>
            <div class="spacer"></div>
        </form>
    </div>
    <div id="companyBrandsTranslationDiv" >
        <div style="padding: 10px;">
            <a id="companyBrandsTranslationAddLink"><g:message code="translation.add.label" /></a>
        </div>
