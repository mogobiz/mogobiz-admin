...
<html>
<head>
	<title><g:message code="customer.event.registrationFailed.label" /></title>
	...
	<div id="page">
		...
		<div class="content">
			...
			<div class="header page">
				<h1><g:message code="customer.event.registrationFailed.label" /></h1>
			</div>
			
			<div id="register" class="padding">
				
				<div class="left">
					<p><g:message code="customer.event.registrationFailed.label" /><br/>
