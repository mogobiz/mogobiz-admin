...
var trueLabel = "${message(code:'default.boolean.true')}";
var falseLabel = "${message(code:'default.boolean.false')}";
...
var defaultUnlimitedLabel = "${message(code:'default.unlimited.label')}";
...
var companySellers_profilesLabel = "${message(code:'company.sellers.profiles.label')}";
